...
export function PerfilView() {
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-5 pb-24 pt-12 md:px-8">
      ...
      <a href="/workspace/conexiones" className="mt-6 inline-block rounded-full px-5 py-2.5 text-[13px] font-semibold" style={{ background: "linear-gradient(180deg,#ffffff,#ededf2)", color: "#0a0810", boxShadow: "0 6px 16px -6px rgba(0,0,0,0.5)" }}>Gestionar conexiones &rarr;</a>
    </main>
  );
}

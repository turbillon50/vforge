  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between border-b border-[rgba(139,92,246,.1)] px-4 py-3">
        ...
        <span className="flex items-center gap-1.5 font-mono text-[11px] text-[var(--fg-muted)]">
          <IconActivity size={11} className="text-[var(--fg-muted)]" />
          {post.date}
        </span>
      </div>
      ...
      <div className="px-4 py-4">
        {!editing ? (
          ...
          <textarea
            className="w-full resize-y rounded-xl border border-violet-500/40 bg-surface-low px-3.5 py-3 text-[14px] font-light leading-[1.75] text-on-surface shadow-[0_0_20px_rgba(124,58,237,.2)] outline-none transition placeholder:text-[var(--fg-muted)]"
        ...
        {editing && (
          <input
            ...
            className="mt-2.5 w-full rounded-lg border border-[rgba(251,191,36,.25)] bg-surface-low px-3 py-2 text-[12px] font-light text-on-surface-variant outline-none placeholder:text-[var(--fg-muted)] shadow-[0_0_16px_rgba(251,191,36,.1)]"
          />
        )}
      </div>
      ...
      <div className="flex items-center gap-2 border-t border-[rgba(139,92,246,.08)] px-4 py-3">
        {isPending ? (
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-lg border border-[rgba(139,92,246,.18)] bg-transparent px-3.5 py-2 text-[11px] font-semibold text-[var(--fg-muted)] transition hover:border-[rgba(139,92,246,.3)] hover:text-[var(--fg-secondary)] active:scale-95"
          >
        ...
        <div className="mx-auto flex max-w-3xl items-center justify-between px-5 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-mono text-[10px] uppercase tracking-widest text-[var(--fg-muted)]">Social Review · V Momentum</p>
            </div>
          </div>
      ...
      <div className="mx-auto w-full max-w-3xl flex-1 px-5 py-8">
        ...
        {filtered.length === 0 ? (
          ...
          >
            ...
            <p className="text-[15px] font-semibold text-[var(--fg-muted)]">Sin posts aquí</p>
            <p className="mt-1 text-[13px] text-[var(--fg-subtle)]">Genera un plan semanal o cambia el filtro</p>
          </motion.div>
        ) : (

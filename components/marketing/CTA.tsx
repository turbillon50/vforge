...
export function CTA() {
  return (
    <section style={{
      position: "relative",
      background: "linear-gradient(180deg, #050a14 0%, #03060e 100%)",
      ...
      <div style={{
        ...
        background: "radial-gradient(ellipse, rgba(59,130,246,0.09) 0%, rgba(109,40,217,0.05) 50%, transparent 70%)",
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", position: "relative", zIndex: 1 }}>
        ...
        <div style={{ maxWidth: 680 }}>
          ...
          <p style={{ marginTop: 28, fontSize: 12, color: "#1e293b", letterSpacing: "-0.01em" }}>

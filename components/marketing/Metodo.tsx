...
export function Metodo() {
  return (
    <section id="metodo" data-theme="dark" className="border-b border-white/[0.05] bg-[#050509] py-24 md:py-32">
      <div className="mx-auto max-w-container px-5 md:px-margin-desktop">
        ...
        <div className="grid gap-px overflow-hidden rounded-2xl border border-app bg-app md:grid-cols-3">
          {steps.map((s, i) => (
            <motion.div key={s.n} initial={false} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.1 }} transition={{ duration: 0.5, delay: i * 0.1 }} className="bg-[#06050f] p-8">

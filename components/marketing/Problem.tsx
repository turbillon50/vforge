...
export function Problem() {
  ...
  return (
    <section data-theme="dark" className="border-y border-app bg-ink/60">
      <div className="mx-auto max-w-container px-5 py-20 md:px-margin-desktop md:py-28">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-12 md:gap-16">
          <div className="md:col-span-5">
            ...
            <p className="mt-5 text-white/50">{t.marketing.problem_body}</p>
          </div>
          ...
          <div className="md:col-span-7">
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              {items.map((p) => (
                ...
                >
                  <div className="flex h-9 w-9 items-center justify-center rounded-md bg-tint-2 text-white/50 group-hover:text-cyber-cyan">
                    <p.icon size={16} />
                  </div>

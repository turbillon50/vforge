...
export function VulcanoBrowser() {
  ...
  return (
    <div style={{ display:"flex", flexDirection:"column",
      ...
      {/* ── CUERPO: VNC + panel ── */}
      <div style={{ flex:"1 0 auto", display:"grid", gridTemplateColumns: fullscreen ? "1fr" : isMobile ? "1fr" : "minmax(0,1fr) minmax(320px,380px)", minHeight: isMobile ? 0 : "min(78vh, 860px)" }}>

...
export const es: Dictionary = {
  ...
  glossary: {
    ...
    terms: [
      ...
      { title: "API", body: "Una puerta que tu frontend usa para pedirle cosas a tu backend. V expone APIs que coinciden con las funciones que describes.", examples: ["GET /api/bookings", "POST /api/stripe/checkout"] },
  ...
  pricing: {
    ...
    plans: [
      ...
      },
      {
        ...
        features: ["Proyectos ilimitados", "V con modelos prioritarios", "Dominios y SSL personalizados", "Bóveda de secretos con rotaciones", "Módulos Stripe, Twilio, Mapas", "Soporte por correo e in-app"],
        cta: "Elegir Studio",
      },
      {
        name: "Forge",
        ...
        features: ["Asientos y roles de equipo", "Auditoría y aprobaciones", "Módulos privados", "Despliegues multi-región", "Políticas de secretos de org", "Ingeniero de éxito dedicado"],
        cta: "Elegir Forge",
      },
    ],
  },
...
export const en: Dictionary = {
  ...
  marketing: {
    ...
    cta_title: "Deja de ensamblar herramientas. Opera un producto.",
    cta_body:
      "Tu stack, tus dominios, tus secretos y tus despliegues, orquestados por V en un solo workspace conversacional.",
    cta_primary: "Crea tu VForge",
    cta_secondary: "Ver precios",
    footer_tagline:
      "VForge es un workspace operativo nativo de IA. Construye, despliega y orquesta cada servicio de tu producto con una sola conversación con V.",

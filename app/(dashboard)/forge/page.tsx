...
export default function ForgePage() {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col overflow-hidden bg-vf-bg">
      <header className="z-10 flex flex-shrink-0 items-center justify-between gap-3 border-b border-vf-border bg-vf-bg px-3 py-3 sm:px-5">
        <div className="flex items-center gap-4 min-w-0">
          <h1 className="flex-shrink-0 text-lg font-semibold text-vf-fg">
            V
          </h1>
          <select
            value={scope}
            ...
            disabled={streaming}
            className="max-w-[46vw] truncate rounded-md border border-vf-border bg-vf-bg-2 px-3 py-2 text-sm text-vf-fg transition-colors focus:border-vf-green focus:outline-none focus:ring-1 focus:ring-vf-green/20 sm:max-w-xs"
      ...
      {streaming && (
        <div
          role="status"
          aria-live="polite"
          className="mx-auto flex w-full max-w-3xl flex-shrink-0 items-center gap-3 border-t border-vf-border bg-vf-bg-2/80 px-4 py-2 text-xs backdrop-blur-md"
        >

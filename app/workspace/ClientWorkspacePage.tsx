    ...
    <div className="min-h-screen bg-[#03020a] pb-24">
      ...
      <div className="mx-auto max-w-2xl space-y-5 px-5 pt-8">
        <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{ease:EASE}}
          ...
          <div className="mt-4 flex flex-wrap gap-3"><a href="/configurador.html" className="flex items-center gap-1.5 rounded-xl bg-white px-3 py-2 text-xs font-semibold text-black transition hover:bg-white/90">Nueva app</a>
